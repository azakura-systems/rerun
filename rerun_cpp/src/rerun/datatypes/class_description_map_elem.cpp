...
// Based on "crates/store/re_sdk_types/definitions/rerun/datatypes/class_description_map_elem.fbs".
...
namespace rerun {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::ClassDescriptionMapElem>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<datatypes::ClassDescriptionMapElem>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<datatypes::ClassDescriptionMapElem>::fill_arrow_array_builder(
...

        {
            ...
            for (size_t elem_idx = 0; elem_idx < num_elements; elem_idx += 1) {
                RR_RETURN_NOT_OK(
                    Loggable<rerun::datatypes::ClassId>::fill_arrow_array_builder(
                        field_builder,
