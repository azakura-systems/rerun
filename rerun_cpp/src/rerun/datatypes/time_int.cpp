...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::TimeInt>::arrow_datatype() {
        static const auto datatype = arrow::int64();
        return datatype;
    }

    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::TimeInt>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<datatypes::TimeInt>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<datatypes::TimeInt>::fill_arrow_array_builder(
