...
// Based on "crates/store/re_sdk_types/definitions/rerun/datatypes/mat3x3.fbs".
...
namespace rerun {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::Mat3x3>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<datatypes::Mat3x3>::fill_arrow_array_builder(
