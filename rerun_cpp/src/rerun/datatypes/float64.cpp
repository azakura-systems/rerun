...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::Float64>::arrow_datatype() {
        static const auto datatype = arrow::float64();
        return datatype;
    }

    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::Float64>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<datatypes::Float64>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<datatypes::Float64>::fill_arrow_array_builder(
