...
// Based on "crates/store/re_sdk_types/definitions/rerun/datatypes/uint32.fbs".
...
namespace rerun {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::UInt32>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<datatypes::UInt32>::fill_arrow_array_builder(
