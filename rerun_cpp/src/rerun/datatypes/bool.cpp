...
// Based on "crates/store/re_sdk_types/definitions/rerun/datatypes/bool.fbs".
...
namespace rerun {
    const std::shared_ptr<arrow::DataType>& Loggable<datatypes::Bool>::arrow_datatype() {
        static const auto datatype = arrow::boolean();
        return datatype;
    }

    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::Bool>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<datatypes::Bool>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<datatypes::Bool>::fill_arrow_array_builder(
