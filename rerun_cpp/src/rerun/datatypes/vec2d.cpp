...
// Based on "crates/store/re_sdk_types/definitions/rerun/datatypes/vec2d.fbs".
...
namespace rerun {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<datatypes::Vec2D>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<datatypes::Vec2D>::fill_arrow_array_builder(
