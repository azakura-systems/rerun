...
// Based on "crates/store/re_sdk_types/definitions/rerun/components/annotation_context.fbs".
...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<components::AnnotationContext>::arrow_datatype() {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<components::AnnotationContext>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<components::AnnotationContext>::fill_arrow_array_builder(
