...
namespace rerun {
    ...
    Result<std::shared_ptr<arrow::Array>>
        Loggable<blueprint::datatypes::VisualizerComponentMapping>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<blueprint::datatypes::VisualizerComponentMapping>::
    ...
    rerun::Error
        Loggable<blueprint::datatypes::VisualizerComponentMapping>::fill_arrow_array_builder(
