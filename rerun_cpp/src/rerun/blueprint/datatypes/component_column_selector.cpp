...
namespace rerun {
    const std::shared_ptr<arrow::DataType>&
        Loggable<blueprint::datatypes::ComponentColumnSelector>::arrow_datatype() {
    ...
    Result<std::shared_ptr<arrow::Array>>
        Loggable<blueprint::datatypes::ComponentColumnSelector>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<blueprint::datatypes::ComponentColumnSelector>::fill_arrow_array_builder(
    ...
    rerun::Error Loggable<blueprint::datatypes::ComponentColumnSelector>::fill_arrow_array_builder(
