...
// Based on "crates/store/re_sdk_types/definitions/rerun/blueprint/components/map_provider.fbs".
...
namespace rerun {
    ...
    Result<std::shared_ptr<arrow::Array>> Loggable<blueprint::components::MapProvider>::to_arrow(
        ...
        if (instances && num_instances > 0) {
            RR_RETURN_NOT_OK(
                Loggable<blueprint::components::MapProvider>::fill_arrow_array_builder(
